      ...
      <section className="grid grid-cols-1 md:grid-cols-3 min-h-screen">
        ...
        >
          <div className="text-center px-8 transition-transform duration-700 group-hover:scale-105">
            ...
            <div className="text-[0.7rem] tracking-[0.25em] uppercase opacity-70">Pièces uniques · Éthique</div>
        ...
        >
          <div className="absolute inset-0 opacity-50" style={{ backgroundImage: "repeating-linear-gradient(45deg, transparent 0 6px, rgba(139,0,0,0.04) 6px 7px), radial-gradient(circle at 30% 70%, rgba(139,0,0,0.15), transparent 60%)" }} />
          <div className="relative text-center px-8 transition-transform duration-700 group-hover:scale-105">
            ...
            <h2 className="font-sans font-bold uppercase text-4xl md:text-5xl mb-3 tracking-wider" style={{ textShadow: "2px 0 #8b0000, -2px 0 #1a1a1a" }}>
              Bijoux
            </h2>
            <div className="text-[0.7rem] tracking-[0.25em] uppercase opacity-70">Mailles · Métal · Contre-culture</div>
            <div className="inline-block mt-8 text-[0.65rem] tracking-[0.35em] uppercase pb-1 border-b border-current opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
