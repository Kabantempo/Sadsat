...
export default function BougiesPage() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 bg-black relative overflow-hidden" style={{ color: "#00ff41" }}>
      ...
      <div className="max-w-6xl mx-auto px-8 relative font-mono">
        <div className="text-center mb-20">
          <div className="text-[0.7rem] tracking-[0.3em] mb-6" style={{ color: "#008f11" }}>&gt; SYS_03</div>
          <h1
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            >
              <div className="aspect-square bg-black mb-4 overflow-hidden border" style={{ borderColor: "rgba(0, 255, 65, 0.1)" }}>
              ...
              <div>
                <div className="text-sm mb-1">candle_{String(i).padStart(3, "0")}.exe</div>
        ...
        <div className="mt-32 text-center border-t pt-12" style={{ borderColor: "rgba(0, 255, 65, 0.15)" }}>
