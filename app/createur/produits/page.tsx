...
import { deleteCreateurProductAction } from '@/app/actions/createur'
  ...
  return (
    <div className="px-4 md:px-6 py-12 max-w-5xl mx-auto">
      <div className="flex items-end justify-between mb-10 gap-4">
        <div>
          <p className="text-[0.62rem] tracking-[0.22em] uppercase text-neutral-400 mb-1">Espace Créateur</p>
            ...
            {products.map((p) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <DeleteProductButton id={p.id} name={p.name} deleteAction={deleteCreateurProductAction} />
                </div>
              </div>
            ))}
          </div>
